...
IIIF image info URI, an optional JSON file
containing the results data of a previous *project-iiif-annotate* project and an
optional IIIF manifest URI.
...
npm run generate -- <taskset> <image-info-uri> [--manifest=uri] [--results=./results.json] [--config=/path/to/config]
